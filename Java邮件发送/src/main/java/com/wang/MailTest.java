    ...
    public static void main(String[] args) throws Exception {
        ...
        Session session = Session.getDefaultInstance(prop, new Authenticator() {//获取和SMTP服务器的连接对象
            public PasswordAuthentication getPasswordAuthentication() {
                //发件人邮件用户名、授权码
                return new PasswordAuthentication("1813024293@qq.com", "yzfgqxkfxcvjbcef");
            }
        });
        ...
        ts.connect("smtp.qq.com", "1813024293@qq.com", "yzfgqxkfxcvjbcef");

        //4、创建邮件对象MimeMessage——点击网页上的写信
        //创建一个邮件对象
        MimeMessage message = new MimeMessage(session);
        //指明邮件的发件人——在网页上填写发件人
        message.setFrom(new InternetAddress("1813024293@qq.com"));//设置发件人
        //指明邮件的收件人，现在发件人和收件人是一样的，那就是自己给自己发——在网页上填写收件人
        message.setRecipient(Message.RecipientType.TO, new InternetAddress("1813024293@qq.com"));//设置收件人
        //邮件的标题——在网页上填写邮件标题
        ...
        DataHandler dh = new DataHandler(new FileDataSource("C:\\gitcode\\maven\\maven测试\\Java邮件发送\\src\\main\\resources\\images\\1.png"));
        ...
        body1.setDataHandler(new DataHandler(new FileDataSource("D:\\github提交代码\\力扣\\13机器人的运动范围，dfs\\机器人的运动范围.txt")));
